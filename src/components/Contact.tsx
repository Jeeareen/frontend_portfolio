  ...
  return (
    <section className="pt-16 pb-6 px-6 bg-[#FAFAFA] text-[#111827] border-t border-gray-200/60 overflow-hidden flex flex-col justify-between">
      <div className="max-w-6xl mx-auto space-y-8 w-full flex-1">
        ...
        {/* 2-Column Grid: Left (Direct Info & CV), Right (Contact Form) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4">
          ...
          >
            {/* Direct Contact Card */}
            <div className="p-7 rounded-2xl bg-white border border-gray-200/90 flex flex-col justify-between space-y-6 shadow-sm">
              <div className="space-y-3">
                ...
                <p className="text-sm font-['Atkinson_Hyperlegible'] text-gray-600 leading-relaxed">
                  Prefer sending an email directly from your mail app? Click below.
                </p>
              </div>
              ...
              <a
                href={`mailto:${email}`}
                className="inline-flex items-center justify-between px-5 py-3.5 rounded-xl bg-[#FFD070]/20 border border-[#FFD070]/60 text-[#111827] font-semibold text-xs tracking-wide font-['Saira_Semi_Condensed'] uppercase hover:bg-[#FFD070]/40 transition-all duration-200 group cursor-pointer"
              >
              ...
              <div className="pt-1 flex items-center gap-3">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl border border-gray-200 text-xs font-semibold font-['Saira_Semi_Condensed'] text-gray-700 hover:text-black hover:border-gray-400 hover:bg-gray-50 transition-all uppercase tracking-wider"
                >
            ...
            <div className="p-7 rounded-2xl bg-white border border-gray-200/90 flex flex-col justify-between space-y-6 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-gray-300 text-[#111827] font-semibold text-xs tracking-wider font-['Saira_Semi_Condensed'] uppercase hover:bg-gray-50 hover:border-gray-400 transition-all"
                >
                ...
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#111827] text-white font-semibold text-xs tracking-wider font-['Saira_Semi_Condensed'] uppercase hover:bg-gray-800 transition-all shadow-sm"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <form ref={formRef} noValidate onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl border bg-gray-50/50 text-sm font-['Atkinson_Hyperlegible'] text-[#111827] placeholder:text-gray-400 focus:outline-none transition-all resize-y ${errors.message
                      ? 'border-red-400 focus:ring-2 focus:ring-red-400/40 focus:border-red-400'
                      : 'border-gray-200 focus:ring-2 focus:ring-[#FFD070] focus:border-transparent'
                      }`}
                  ></textarea>
                  ...
                  <AnimatePresence mode="wait">
                    {status === 'idle' && (
                      <motion.button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#111827] text-white font-semibold text-xs tracking-wider font-['Saira_Semi_Condensed'] uppercase hover:bg-gray-800 transition-all shadow-sm cursor-pointer"
                      >
                    ...
                    {status === 'error' && (
                      <motion.button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-[#111827] font-semibold text-xs tracking-wider font-['Saira_Semi_Condensed'] uppercase shadow-md cursor-pointer transition-colors"
                      >
                        <svg className="w-4 h-4 text-[#111827] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
