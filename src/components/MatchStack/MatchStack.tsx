...
export const MatchStack: React.FC<MatchStackProps> = ({ cards = defaultMockCards, onComplete }) => {
  ...
  return (
    <div className="relative flex h-[480px] w-full max-w-[520px] min-w-0 max-w-full flex-col items-center justify-center overflow-hidden bg-gray-50 rounded-2xl shadow-lg touch-none mx-auto mt-4 sm:mt-6 perspective-1000">
      ...
      <div className="relative h-full w-full flex items-center justify-center">
        <AnimatePresence>
          ...
          <motion.div
            ...
            className="absolute z-30 flex h-[400px] w-[280px] cursor-grab flex-col rounded-xl bg-white shadow-xl active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-blue-500 border border-gray-100 preserve-3d"
          >
            {/* Front Face */}
            <div className="absolute inset-0 flex flex-col p-6 bg-white rounded-xl backface-hidden">
            ...
            <div className="absolute inset-0 flex flex-col p-6 bg-white rounded-xl rotate-y-180 backface-hidden">
