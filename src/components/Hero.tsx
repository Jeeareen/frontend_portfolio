...
export default function Hero({
  ...
  return (
    <section className="min-h-[85vh] flex flex-col justify-center items-center text-center px-6 py-20 bg-[#FAFAFA] text-[#111827]">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col items-center w-full space-y-4 text-center">
          <div className="relative inline-block text-center">
            ...
            <motion.div
              ...
              className="absolute -top-3 -right-2 md:-right-4 inline-flex items-center cursor-pointer select-none bg-white border border-gray-200/90 shadow-xs rounded-full py-1.5 px-2.5 transition-all hover:border-gray-300 z-10"
            >
        ...
        <div className="flex items-center gap-4 pt-4">
          <a
            ...
            className="p-3 rounded-full bg-white border border-gray-200 text-gray-700 hover:text-black hover:border-gray-400 hover:shadow-sm transition-all"
          >
