      ...
      >
        ...
        <div className="flex items-center gap-4 pt-4">
          <a
            ...
            className="p-3 rounded-full bg-white border border-gray-200 text-gray-700 hover:text-black hover:border-gray-400 shadow-sm hover:shadow-lg hover:-translate-y-0.5 active:scale-95 active:translate-y-0.5 transition-all duration-150 cursor-pointer select-none"
          >
