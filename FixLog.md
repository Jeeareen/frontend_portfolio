...
### 1. Availability Indicator Positioning & Touch Toggle
...
- **What changed:** Positioned the indicator at `-top-[20px]` in [`Hero.tsx`](file:///c:/dev/frontend_portfolio/src/components/Hero.tsx) with container top padding (`pt-28 md:pt-32`), creating clear clearance, and added an `onClick` toggle so touching it again closes the banner on mobile.
